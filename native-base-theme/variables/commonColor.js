...
export default {
  ...
  checkboxBgColor: "rgba(241,89,42,1)",
  checkboxSize: 20,
  checkboxTickColor: "#fff",

  // Color
  brandPrimary: platform === "ios" ? "#007aff" : "rgba(241,89,42,1)",
  brandInfo: "#3F57D3",
  brandSuccess: "#5cb85c",
  brandDanger: "#d9534f",
  brandWarning: "#f0ad4e",
  ...
  toolbarDefaultBg: platform === "ios" ? "#F8F8F8" : "#EE5A24",
  toolbarHeight: platform === "ios" ? 64 : 64,
  toolbarSearchIconSize: platform === "ios" ? 20 : 17,
